...
module.exports = function(){
	//total: 总计, sub 小计
	this.count = {total:0,sub:0,白:0,绿:0,蓝:0,紫:0,橙:0};
	...
	this.create = function(){
		...
		while(cards.length < 10){
			...
			console.log('rnd:' + rnd + ' total:' + this.count.total + ' sub:' + this.count.sub);
			if( ( rnd == 1 || this.count.total >= 100 ) &&  this.count['橙'] == 0){
